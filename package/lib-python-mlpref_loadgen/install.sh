...
${CK_ENV_COMPILER_PYTHON_FILE} -m pip install dist/mlperf_loadgen-0.5a0-cp36-cp36m-linux_x86_64.whl --prefix=${EXTRA_PYTHON_SITE} ${PIP_INSTALL_OPTIONS} --force-reinstall
